...
const ExperienceCard = ({ title, company, duration, description, tags }: ExperienceCardProps) => {
    return (
        <div className="text-white w-[600px] p-6 bg-zinc-700 rounded-lg">
            <div className="flex justify-between items-start">
                <p className="text-lg text-zinc-400">{duration}</p>
                <div className="ml-4">
                    <h1 className="text-xl font-semibold">{title} {company}</h1>
                </div>
            </div>
